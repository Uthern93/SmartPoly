...
public class AdapterPost extends RecyclerView.Adapter<com.jtmk.smartpoly.AdapterPost.MyHolder> {
    Context context;
    String myuid;
    ...
    public void searchDataList(ArrayList<ModelPost> searchList) {
        modelPosts = searchList;
